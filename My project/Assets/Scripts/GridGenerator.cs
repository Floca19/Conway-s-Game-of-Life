...
namespace Assets.Scripts
{
    public class GridGenerator : SerializedMonoBehaviour
    {
        ...
        public void resetField()
        {
            ...
            {
                cell.GetComponent<Cell>().IsAlive = false;
            }
        ...
        private void Update()
        {
            if (Input.GetKeyDown(KeyCode.L))
            {
                    ...
                    Debug.Log("spaceship");
                    //GridGenerator._cells[_me.D,_me.H,_me.W]._cellState = 1; 
                    GridGenerator._cells[_me.D,_me.H,_me.W].IsAlive = true;
                    GridGenerator._cells[_me.D,_me.H,_me.W+1].IsAlive = true; 
                    GridGenerator._cells[_me.D,_me.H+2,_me.W+1].IsAlive = true;  
                    GridGenerator._cells[_me.D,_me.H,_me.W+2].IsAlive = true;
                    GridGenerator._cells[_me.D,_me.H+1,_me.W+2].IsAlive = true; 
